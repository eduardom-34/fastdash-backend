...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "https://fastdash-frontend.vercel.app", "https://fastdash-frontend-git-main-cesar-cascos-projects.vercel.app"], # Ajusta el puerto de tu React
